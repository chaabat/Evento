...
@section('home')
    <div style="background:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('photos/event.jpg') }}') no-repeat center;background-size:cover"
            ...
            <div class="flex flex-col md:flex-row mx-auto space-y-2 md:space-y-0 max-w-lg md:max-w-full">
                <div class="w-full flex items-center">
                    <span class="p-2 bg-gray-50 md:rounded-l-lg">
                        <img src="{{ asset('photos/titre.png') }}" class="h-8" alt="">
                    </span>
                    <input name="filterTitle" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 outline-none"
                        placeholder="Titre">
                </div>
                <div class="w-full flex items-center">
                    <span class="p-2 bg-gray-50">
                        <img src="{{ asset('photos/categorie.png') }}" class="h-8   " alt="">
                    </span>
                ...
                <button type="submit"
                    class="p-3 w-full  justify-center flex items-center text-sm font-medium h-full text-white bg-purple-700 md:rounded-r-lg ">
        ...
        <div class="flex flex-wrap  mt-8 ">
            @if ($searched)
                @if ($events->isEmpty())
                    <div class="bg-white text-purple-700 p-6 w-full rounded-lg">
                    ...
                    @foreach ($events as $evenement)
                        <div class="xl:w-1/3 md:w-1/2 p-4">
                            <div class="bg-white p-6 rounded-lg">
                                ...
                                <h3 class=" text-black font-mono text-sm mb-12 ">Categorie :
                                    {{ $evenement->categorie->name }}
                                </h3>

                                <h2 class="text-purple-700 font-mono text-l  ">
                                    {{ $evenement->titre }}
                                </h2>
                                        ...
                                        <div class="flex w-full gap-6">
                                            ...
                                            <div class="flex items-center">
                                                <svg fill="#919191" height="16" width="16" version="1.1"
                                                    ...
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 283.629 283.629"
                                                    xml:space="preserve" stroke="#919191">
